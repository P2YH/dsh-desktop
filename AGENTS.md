...
- `dsh-plugin-architecture-review/` owns the standalone Architecture Review Host, Web Client, and Profile bundle; it must not depend on private Desktop or Electron APIs.
